...
public class calc {
    ...
    private static void printHistory() {
        try (BufferedReader br = new BufferedReader(new FileReader(new File("calc_history.txt")))) {
            String line;
    ...
    private static int calculate(String equation) {
        Stack<Character> opStack = new Stack<>(); // Stack holding operators
        Stack<Integer> valStack = new Stack<>(); // Stack holding operands
        equation = equation.replaceAll("\\s+", ""); // Removing white spaces
    ...
    private static void saveInHistory(String message) {
        try (FileWriter fw = new FileWriter(new File("calc_history.txt"), true)) {
